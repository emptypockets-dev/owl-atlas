...
- Preserve the 51 source records, 18 image records, three BnF specimen records,
  ...
  Source 32 supports the original schematic minting illustration; see
  `research/minting-findings.json`. The diagram is not a coin photograph or a
  reconstruction of a particular workshop, die design or tool set.
