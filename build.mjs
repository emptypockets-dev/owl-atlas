...
import {escapeHtml, sourceRefs, photoMarkup, closeReadingMarkup, comparisonMarkup, familyFacesMarkup, geographyMarkup, atticaLocatorMarkup, marketFamilyMarkup, marketSummaryMarkup, marketCurrentMarkup, marketHistoryMarkup, marketFamiliesMarkup, marketLedgerMarkup, marketCsv, derivedSrcset, photoSizesFor, photoMaxWidthFor} from './src/render.mjs';
...
const replacements = {
  ...
  ATTICA_LOCATOR: atticaLocatorMarkup(data, geography),
