...
## Creator kit (withdrawn)

The creator kit page at `/kit/` was withdrawn on 23 September 2026 at the
owner's request and is no longer published. While it was live it republished
only the licences recorded above and granted nothing further. Its source is
archived, unpublished, in `research/kit-page-archived/`. Every photograph keeps
the credit, licence and rights record stated in this file and on the page that
shows it.
